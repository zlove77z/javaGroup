...
insert into test values ('강감찬',60,'남자','부산');
insert into test values ('이사랑',19,'여자','인천');
insert into test values ('이순신',90,'남자','부산');
insert into test values ('강소연',28,'여자','청주');
insert into test values ('김영수',33,'남자','청주');
insert into test values ('이창식',22,'남자','인천');
insert into test values ('박종두',28,'남자','청주');
insert into test values ('박세연',21,'여자','제주');
insert into test values ('오로지',40,'여자','청주');
insert into test values ('오종지',35,'여자','인천');
insert into test values ('오종지종',37,'남자','청주');
insert into test values ('김자월',22,'여자','제주');
insert into test values ('오자월',37,'여자','청주');
insert into test values ('오이자월',29,'여자','제주');
insert into test values ('김자월화',25,'여자','청주');
